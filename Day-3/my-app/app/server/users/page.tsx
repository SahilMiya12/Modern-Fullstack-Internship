...
//In SSR, secret Keys such as API calls, password,etc are not exposed
//In browser's network tab

//what do we see in network tab?
//all the (request) information can easily be seen 

//In CSR, all these details such as network calls, APIs, secret keys
//are exposed